...
<img src="src/frontend/public/dart-logo.svg" width="64" height="64" alt="Logo" />
...
<div align="center">
  <img src="https://raw.githubusercontent.com/aymenfurter/presentation-coach/main/fullpreview.png" alt="Presentation Coach Preview" width="100%" />
</div>
...
| Feature | Description |
|---------|-------------|
| **Real-time Voice** | Low-latency speech-to-speech interaction using **Azure Voice Live API**. |
| **Visual Understanding** | Analyzes your screen share and slides using **Azure Content Understanding**. |
| **Smart Coaching** | **GPT-4.1** orchestrates the session, providing actionable feedback based on industry standards. |
| **Live Feedback** | Instantaneous responses via WebSockets for a fluid conversation. |
